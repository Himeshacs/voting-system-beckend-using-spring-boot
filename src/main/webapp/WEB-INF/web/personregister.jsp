                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>successfully saved as a person</p>
                                            </div>
...
<div class="col-12">
  ...
  function Person_save(){
	  ...
	  //citizen-->> reff_no district_id						     
	     ...
	     var reff_code_txt,team_id_txt,reff_no_txt,district_id_txt;
	   ...
	   // 	 alert(person_id);
	    	 ...
	    	 $.ajax({
		            ...
		            data: {"p_id":person_id,"fname":fname,"mname":mname,"lname":lname,"add1":add1,
		                ...
		                ,"nic":nic,"exampledate":exampledate,"fax":fax}, // fix: need to append your data to the call
	    	...
	    	if(reff_code != null || team_id != null){
	    		
	    		 reff_code_txt =reff_code;
	    		 team_id_txt=team_id;
	    	 ...
	    	 }else if(reff_no != null || district_id != null){
	    		 reff_no_txt=reff_no;
	    		 district_id_txt=district_id;
	    	 ...
	    	 $.ajax({
		            type: "POST",
		            url: "webperson",
		            data: {"fname":fname,"mname":mname,"lname":lname,"add1":add1,
		                "add2":add2,"add3":add3,"p_type":p_type,"mobile1":mobile1,"mobile2":mobile2,"Email":Email
		                ,"nic":nic,"exampledate":exampledate,"fax":fax,
		                "reff_code":reff_code_txt,"team_id":team_id_txt,"reff_no":reff_no_txt,"district_id":district_id_txt}, // fix: need to append your data to the call
		            success: function (data) {
					//alert(data);
					var myJSON = JSON.stringify(data);	
					//alert(myJSON);
					 var json = JSON.parse(data);
					 var id=myJSON[0]['p_id'];
					 var name=myJSON[0]['p_name'];
					//alert(id);					
		                ...
		                //	 alert(id);
                             ...
                             setTimeout(function(){ 
                             	// $('#idclose_btn').trigger('click');
		                            	   ...
		                            	   $("#alert_box").append("<div class='lert alert-success alert-dismissible fade show' role='alert'><strong>Data saved successfully!</strong> You should check in on some of those fields below.<button type='button' id='iderrclose' class='close' data-dismiss='alert' aria-label='Close'><span class='fa fa-times'></span></button></div>");
		      		          setTimeout(function(){ 
		      		          	$('#iderrclose').trigger('click');
		      		                      }, 2000);
		                       	} 
			...
			$.ajax({
	           ...
	           var initial_name="",status_name="";
	                    ...
	                    for(var i=0;i<json.length;i++){
	                      ...
	                      trHTML +='<tr><th scope="row">'+ id +'</th><td>'+fname+'</td><td>'+lname+'</td><td>'+mobile1+'</td><td>'+nic+'</td><td>'+register+'</td><td><span class="status-p bg-primary">'+status_name+'</span></td><td><span class="status-p bg-primary">'+fax+'</span></td><td><button type="button" onclick=edit(\''+encodeURIComponent(id)+'\',\''+encodeURIComponent(fname)+'\',\''+encodeURIComponent(mname) +'\',\''+encodeURIComponent(lname) +'\',\''+encodeURIComponent(add1)+'\',\''+encodeURIComponent(add2)+'\',\''+encodeURIComponent(add3)+'\',\''+encodeURIComponent(dob)+'\',\''+encodeURIComponent(mobile1)+'\',\''+encodeURIComponent(mobile2)+'\',\''+encodeURIComponent(email)+'\',\''+encodeURIComponent(fax)+'\',\''+encodeURIComponent(nic)+'\'); class="btn btn-default bg-blue">Edit</button></td></tr>';
  ...
  function edit(id,fname,mname,lname,add1,add2,add3,dob,mobile1,mobile2,email,fax,nic){
